...
export const metadata = {
    title: 'Static Fetching - NextJS 13.4 Image Gallery Demo',
}
    ...
    return (
        <div className="d-flex flex-column algin-items-center">
            <Alert>
                ...
                <br />
                Even though the Unsplash API always returns a new image, we get the same one after refreshing, from the cache.
                <br />
                Until the project is re-compiled.
            </Alert>
