...
export const metadata = {
    title: 'Incremental Static Regeneration - NextJS 13.4 Image Gallery Demo',
}
    ...
    return (
        <div className="d-flex flex-column algin-items-center">
            <Alert>
                ...
                <br />
                A new image is fetched every 30 seconds (after refreshing the page) and then served from cache for that duration.
            </Alert>
